...
function Signup() {
    ...
    const handleSignup = () => {
        ...
        if (username && password) {
            ...
            setMsg('Username and password must not be empty')
        }
    }
    return (
        <main className="logup-page">
            <div className="signup container">
                ...
                <div className="input">
                    ...
                    <input type={isVisible ? "text" : "password"} placeholder="Password" onChange={e => setPassword(e.target.value)} value={password} required />
                    <input type={isVisible ? "text" : "password"} placeholder="Confirm Password" onChange={e => setConfirmPw(e.target.value)} value={confirmPw} required />
                    <svg onClick={handleEyeClick} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style={{bottom: '55px'}}>
                        {isVisible ?
                            <>
